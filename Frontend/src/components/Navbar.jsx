    ...
    <div className="flex items-center justify-between h-[100px] shadow-md px-6">
      ...
      <div className="flex items-center m-2">
        <input
          type="text"
          placeholder="search"
          className="p-[15px] border-[#f096dd] border-[1px] border-solid w-[500px] outline-none rounded-lg mr-[-30px]"
        />
      ...
      <div className="flex items-center">
        ...
        <div className="flex items-center space-x-2 border border-pink-300 p-2 rounded-lg hover:bg-pink-100 duration-300">
          <FaUser className="text-[#e455c5] hover:text-pink-600 transition duration-300" />
          <span className="text-[#e455c5] hover: teext-pink-600 font-semibold">
            Login
          </span>
        </div>
      </div>
